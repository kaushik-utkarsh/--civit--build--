...
import set_password from "../../assets/images/demo.avif";
                ...
                <div>
                    <Container fluid className="">
                        <Row className="">
                            ...
                            <Col lg={5}>
                                <div className="authentication-page-content m-5 p-5 d-flex align-items-start">
                                    <div className="w-100">
                                                    ...
                                                    <div className="p-2 mt-5">
                                                        <AvForm className="form-horizontal" onValidSubmit={this.handleSubmit} >
                                                            ...
                                                            <div className="mt-2 text-center d-flex" style={{ justifyContent: 'space-around' }}>
                                                                ...
                                                                <div className='text-muted' style={{ paddingLeft: '5%' }}>
                                                            ...
                                                            <div className="mt-4 text-center">
                                                                <button
                                                                    className="w-md waves-effect waves-light save-button-onboarding-initial"
                                                                    type="submit"
                                                                >
                                                                    Continue
                                                                </button>
